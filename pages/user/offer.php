							...
							<nav id="nav">
								<ul>
									...
									<ul>
                                                                            ...
                                                                            <li class="current"><a href="offer.php">Мои заявки</a></li>
			...
			<!-- Main -->
				<div id="main-wrapper">
					<div class="container">
                                            ...
                                            <div class="col-8">
                                               <form name="offer" method="get" action="offer.php">

                                                <h3>Таблица ожидания (в качестве покупателя)</h3>
                                                <table id="zagolovok">
                                                    <thead>
                                                        <tr>
                                                            <td></td>
                                                            <td>Название продукта</td>
                                                            <td>Цена за один лот</td>
                                                            <td>Количество</td>
                                                            <td>Дата и время</td>
                                                        </tr>
                                                    </thead>
                                                    <?php echo $table_offer_cusromer;?>
                                                </table>
                                                <br/>
                                                    <input name="offer_customer" type="submit" value="Снять заявку"/>                                                    
                                                </form>
                                                ...
                                                <h3>Таблица ожидания (в качестве продавца)</h3>
                                                <table id="zagolovok">
                                                    <thead>
                                                        <tr>
                                                            <td></td>
                                                    ...
                                                    <?php echo $table_offer_seller;?>
                                                    <br/>
                                                    
                                                </table>
                                                <br/>
                                                    <input name="offer_seller" type="submit" value="Снять заявку"/>                                                    
                                                </form>
                                            </div> 
